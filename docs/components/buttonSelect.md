...
export default {
  data() {
    return {
      list: [
        { descName: "中考资讯", value: "1" },
        { descName: "高考资讯", value: "2" },
        { descName: "新闻资讯", value: "3" },
      ],
    };
  },
};
...
<template>
    <one-button-select :list="list2" :multiple="true"/>
</template>
...
export default {
    data() {
        return {
            ...
            list2: [
                { descName: 'pc适配', value: '1' },
                { descName: '小程序待测试', value: '2' }
            ]
        }
    }
}
...
```vue
<template>
  <one-button-select :list="list" :multiple="true"/>
</template>
